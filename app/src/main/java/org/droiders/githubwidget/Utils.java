...
public class Utils {
    ...
    public static List<DayContributions> svgToContributionsList(String svg) {
        List<DayContributions> contributionsList = new ArrayList<>(52 * 7);
        ...
        while (matcher.find()) {
            ...
            int dataCount = Integer.parseInt(matcher.group(2));

            DayContributions contributions = new DayContributions(
                    matcher.group(3),
                    dataCount,
                    color);
    ...
    static List<DayContributions> getTestList() {
